...
const Footer = () => {
  ...
  <div className="container">
    <div className="footer__top">
      ...
      <p>© 2024–2025 «Аккорд» — музыкальные инструменты, интернет-магазин. Все права защищены.</p>
      <p>Копирование материалов с сайта без ссылки на этот ресурс запрещено.</p>
    </div>
      </div>
